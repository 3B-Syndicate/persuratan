    ...
    <div class="rangka-surat">
        ...
        <table>
            ...
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$showData->Tanggal_Rapat}}</td>
            </tr>
            <tr>
                <td style="width: 30%; vertical-align: top;">Ruang Rapat</td>
                <td style="width: 5%; vertical-align: top;">:</td>
                <td style="width: 65%;">{{$showData->Ruang_Rapat}}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 30%;">Tipe Rapat</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$showData->Tipe_Rapat}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Validasi</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$showData->Validasi}}</td>
            </tr>
        </table>
        
        <p>{{$showData->Notulensi}}
        </p>
        <br>
