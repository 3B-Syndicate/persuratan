...
<div class="rangka-surat">
        ...
        <table>
            ...
            <tr>
                <td style="width: 30%; vertical-align: top;">Tanggal Diterima</td>
                <td style="width: 5%; vertical-align: top;">:</td>
                <td style="width: 65%;">{{$showData->Tanggal_Diterima}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Pengirim</td>
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$showData->Pengirim}}</td>
            </tr>
            <tr>
                <td style="width: 30%;">Perihal Surat</td>
                <td style="width: 5%;">:</td>
            ...
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 65%;">{{$showData->Lampiran}}</td>
            </tr>
        </table>
